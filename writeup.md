...
There are multiple problems I have occurred. One of them was labels from `scipy.ndimage.measurements.label()` thus I had to redesign the architecture to track frames and not their labels.

Another problem is confidence of the images detection of the classifier vs. false negatives. Thus it was difficult to find a good combination of values:
